...
![fig1](https://github.com/stan-ja/stan-ja/tree/master/part04/chap33/fig/fig1.png)
```text
real sum(real x[])
```
`x`の要素の総和を返す。上の定義を参照。
...
```
`x`の要素の総乗を返す。
![fig2](https://github.com/stan-ja/stan-ja/tree/master/part04/chap33/fig/fig2.png)
```text
