...
![$$ p(y \mid \dots,\beta_k,\dots,\beta_{k'},\dots,\sigma) = p(y \mid \dots,d\beta_k,\dots,\frac{d}{c}\beta_{k'},\dots,\sigma) $$](fig/fig07.png)^[訳注: $x_{k'}$の係数は正しくは$(\beta_{k'}+c(1-d)\beta_{k)$のようです。]
