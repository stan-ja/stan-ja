...
![$$ p(\rho,\theta)=p(\rho | \theta)p(\theta0) $$](fig/fig01.png)

から値が抽出されます。Stanを含むHMCのほとんどの応用では補助分布としてはパラメータθに依存しない多変量正規分布

![$$ \rho \sim MultiNormal(0,\sigma) $$](fig/fig02.png)
...
![ハミルトニアン](fig/fig03.png)

で定義され、項T

![運動エネルギー](fig/fig04.png)

は"運動エネルギー",項V

![ポテンシャルエネルギー](fig/fig05.png)
...
![$$ Leapfrog of \rho,\theta $$](fig/fig10.png)
...
![$$ min(1,\exp(H(\rho,\theta)-H(\rho^*,\theta^*))) $$](fig/fig11.png)
